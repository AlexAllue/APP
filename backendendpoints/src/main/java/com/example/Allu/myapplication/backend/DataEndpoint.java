 ...
 */
@Api(name = "taskData", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.myapplication.Allu.example.com", ownerName = "backend.myapplication.Allu.example.com", packagePath = ""))
public class DataEndpoint {
    @ApiMethod(name = "storeTask")
    public void storeTask(TaskData taskBean) {
        ...
        try {
            ...
            taskEntity.setProperty("opcional", taskBean.getOpcional());
    ...
    public List<TaskData> getTasks() {
        ...
        for (Entity result : results) {
            ...
            taskBean.setOpcional((String) result.getProperty("opcional"));
