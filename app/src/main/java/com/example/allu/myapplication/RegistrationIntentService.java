...
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Intent registrationComplete = new Intent(SettingsActivity.REGISTRATION_COMPLETE);
    ...
    private void sendRegistrationToServer(String token) throws IOException{
        ...
        Registration.Builder regbuilder = new Registration.Builder(AndroidHttp.newCompatibleTransport(),new AndroidJsonFactory(),null).setRootUrl("https://weathernow-b8825.appspot.com/_ah/api/");
        Registration regService = regbuilder.build();
